...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        //then
        Order getOrder = orderRepository.findOneById(orderId);
    ...
    public void 주문취소() throws Exception {
        ...
        //given
        Member membmer = createMember("회원2");
        Book book = createBook("book", 10000, 10);

        int orderCount = 2;

        Long orderId = orderService.order(membmer.getId(), book.getId(), orderCount);
        ...
        assertEquals("주문이 취소된 상품은 그만큼 재고가 증가해야 합니다. ", 10, book.getStockQuantity());
    }
